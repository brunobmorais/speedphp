...
final class MyPreferenceClient extends MercadoPagoClient
{
     ...
     */
    public function create(array $request, ?RequestOptions $request_options = null): MyPreference
    {
        $response = parent::send(self::URL, HttpMethod::POST, json_encode($request), null, $request_options);
        $result = Serializer::deserializeFromJson(MyPreference::class, $response->getContent());
     ...
     * @throws \Exception if the request fails.
     */
    public function get(string $id, ?RequestOptions $request_options = null): MyPreference
    {
     ...
     * @throws \Exception if the request fails.
     */
    public function update(string $id, array $request, ?RequestOptions $request_options = null): MyPreference
    {
